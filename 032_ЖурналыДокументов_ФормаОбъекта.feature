...
Сценарий: Открытие формы журнала документов "Документы бронирования"
...
Сценарий: Открытие формы журнала документов "СФР. Пачки, реестры, описи"
...
Сценарий: Открытие формы журнала документов "Сверка карточек воинского учета"

	Дано Я открываю основную форму журнала документов "СверкаКарточекВоинскогоУчета"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму журнала документов СверкаКарточекВоинскогоУчета"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму журнала документов СверкаКарточекВоинскогоУчета"
	И Я закрываю текущее окно
